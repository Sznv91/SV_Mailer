...
public class ReceiptDateSplitHolder extends AbstractReceiptViewHolder {
    ...
    private final Observer<Integer> observer = new Observer<Integer>() {
        ...
        public void onChanged(Integer integer) {
            ...
            if (integer == SessionPresenter.THEME_LIGHT) {
                ...
                tabIconColor = ContextCompat.getColor(App.getInstance().getApplicationContext(), R.color.active_fonts_lt);
            } else {
                ...
                tabIconColor = ContextCompat.getColor(App.getInstance().getApplicationContext(), R.color.active_fonts_dt);
            }
            Drawable calendar_icon = ContextCompat.getDrawable(App.getInstance().getApplicationContext(), R.drawable.ic_statistic_calendar);
    ...
    public void bind(EvoReceipt entity) {
        ...
        int numMonthOfYear = entity.getDate_time().getMonthOfYear();
        ...
        int dayOfMonth = entity.getDate_time().getDayOfMonth();
        int year = entity.getDate_time().getYear();
