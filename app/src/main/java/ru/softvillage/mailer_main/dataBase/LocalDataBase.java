...
import ru.softvillage.mailer_main.dataBase.entity.PartialEvoReceiptEvoDbUpdate;
...
@Database(entities = {EvoReceipt.class,
        PartialEvoReceiptEvoDbUpdate.class,
        PartialEvoReceiptSvDbUpdate.class,
        PhoneNumber.class,
        Email.class,
        SentEntity.class,
        NotFiscalizedReceipt.class}, version = 1, exportSchema = false)
